...
class ITunesDBSongItem
{
	...
	public String toString()
	{
		return new StringBuffer("[tagSize] ").append(tagSize)
								...
								.append('\t').append("[contentCount] ").append(contentCount)
								.append('\t').append("[recordIndex] ").append(recordIndex)
								.append('\t').append("[unknown6] ").append(unknown6)
								.append('\t').append("[unknown7] ").append(unknown7)
								.append('\t').append("[unknown8] ").append(unknown8)
								.append('\t').append("[date] ").append(new java.util.Date( ITunesDBParser.macDateToDate(date) ).toString())
								.append('\t').append("[date] ").append(date)
								.append('\t').append("[filesize] ").append(filesize)
								.append('\t').append("[duration] ").append(duration)
								.append('\t').append("[trackNumber] ").append(trackNumber)
								.append('\t').append("[unknown13] ").append(unknown13)
								.append('\t').append("[unknown14] ").append(unknown14)
								.append('\t').append("[bitrate] ").append(bitrate)
								.append('\t').append("[samplerate] ").append(samplerate)
								.toString();
	}
