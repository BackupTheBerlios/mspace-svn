...
public class ITunesDBParser
{
	...
	boolean save(ITunesDB database)
	{
		...
		try
		{
			...
			FileOutputStream fos = new FileOutputStream( myPod.getBackend().getPreferences().getIPodPath() 
																										+ File.separator + ITUNES_DB_PATH );
	...
	private static ITunesDBSongItem parseSongItem(InputStream fis)
	{
		...
		try
		{
			...
			fis.read(dword); songItem.setTagSize(littleEndianToInt(dword));
			fis.read(dword); songItem.setRecordSize(littleEndianToInt(dword));
			fis.read(dword); songItem.setContentCount(littleEndianToInt(dword));
			fis.read(dword); songItem.setRecordIndex(littleEndianToInt(dword));
			fis.read(dword); songItem.setUnknown6(littleEndianToInt(dword));
			fis.read(dword); songItem.setUnknown7(littleEndianToInt(dword));
			fis.read(dword); songItem.setUnknown8(littleEndianToInt(dword));
			fis.read(dword); songItem.setDate(littleEndianToInt(dword));
			fis.read(dword); songItem.setFilesize(littleEndianToInt(dword));
			fis.read(dword); songItem.setDuration(littleEndianToInt(dword));
			fis.read(dword); songItem.setTrackNumber(littleEndianToInt(dword));
			fis.read(dword); songItem.setUnknown13(littleEndianToInt(dword));
			fis.read(dword); songItem.setUnknown14(littleEndianToInt(dword));
			fis.read(dword); songItem.setBitrate(littleEndianToInt(dword));
			fis.read(dword); songItem.setSamplerate(littleEndianToInt(dword));
