/*
 * This code has been stolen from the article
 * Building a better .NET
 * Application Configuration Settings Class by
 * Rick Strahl
 * http://www.west-wind.com/articles.asp
 * 
 * Modified by sergio.rubio@hispalinux.es
 */
...
namespace WeekPlanner
{
	...
	public abstract class AppConfiguration
	{
		...
		public AppConfiguration(string EncryptFields,string EncryptKey) 
		{
		...
		/// potentially with Utils.SerializeObject/DeserializeObject
		/// </summary>
		/// <param name="DontLoadFromConfig"></param>
		public AppConfiguration(bool DontLoadFromConfig)
		{
		}
		...
		public void ReadKeysFromConfig() 
		{
			...
			foreach(MemberInfo Member in Fields) 
			{
				...
				if (TypeName == "string")
					Utils.SetPropertyEx(this,Fieldname,Value);
				else if (TypeName.StartsWith("int") )
					Utils.SetPropertyEx(this,Fieldname,Convert.ToInt32(Value));
				else if (TypeName == "boolean") 
					if (Value.ToLower() == "true") 
						Utils.SetPropertyEx(this,Fieldname,true);
					else
						Utils.SetPropertyEx(this,Fieldname,false);
				else if (TypeName == "datetime")
					Utils.SetPropertyEx(this,Fieldname,Convert.ToDateTime(Value));
				else if (TypeName == "decimal") 
					Utils.SetPropertyEx(this,Fieldname,Convert.ToDecimal(Value));
				else if (TypeName == "byte") 
					Utils.SetPropertyEx(this,Fieldname,Convert.ToByte(Value));
				else if (TypeName == "float") 
					Utils.SetPropertyEx(this,Fieldname,Convert.ToDouble(Value));
				else if (TypeName == "double") 
					Utils.SetPropertyEx(this,Fieldname,Convert.ToDouble(Value));
				else if(Field != null  && Field.FieldType.IsEnum)
					Utils.SetPropertyEx(this,Fieldname,Enum.Parse(Field.FieldType,Value) );
				else if (Property != null  && Property.PropertyType.IsEnum)
					Utils.SetPropertyEx(this,Fieldname,Enum.Parse( Property.PropertyType,Value) );
			}
