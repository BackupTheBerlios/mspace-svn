...
namespace WeekPlanner
{
	...
	public class Utils
	{
		...
		{
			return Utils.ExtractString(Source,BeginDelim,EndDelim,false);
		}
		...
		public static object GetPropertyEx(object Parent, string Property) 
		{
			...
			if ( lnAt < 0) 
			{
				...
				// *** Get the member
				Member = Type.GetMember(Property,Utils.MemberAccess)[0];
			...
			Member = Type.GetMember(Main,Utils.MemberAccess)[0];
			...
			return Utils.GetPropertyEx(Sub,Subs);
		}
