...
[assembly:PluginInfo (
				"DashboardFrontend",
				"Dashboard frontend",
				"Sends clue packets to dashboard when a song changes.",
				PluginType.Passive)]

public class DashboardFrontend : IPlugin
{
	...
	{
		PlayerEvent pe = evt as PlayerEvent;
		if (pe.Type == PlayerEvent.EventType.SongChanged)
