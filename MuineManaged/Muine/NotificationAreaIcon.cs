...
public class NotificationAreaIcon : Plug
{
	...
	public void Init ()
	{
		Raw = egg_tray_icon_new (AppContext.Catalog.GetString ("Muine music player"));
	...
	private void CreatePopupMenu ()
	{
		...
		previous_song_menu_item = new ImageMenuItem (AppContext.Catalog.GetString ("_Previous Song"));
		previous_song_menu_item.Image = new Gtk.Image ("muine-previous", IconSize.Menu);
		menu.Append (previous_song_menu_item);
		next_song_menu_item = new ImageMenuItem (AppContext.Catalog.GetString ("_Next Song"));
		...
		play_song_menu_item = new ImageMenuItem (AppContext.Catalog.GetString ("Play _Song..."));
		play_song_menu_item.Image = new Gtk.Image (Stock.Add, IconSize.Menu);
		menu.Append (play_song_menu_item);
		play_album_menu_item = new ImageMenuItem (AppContext.Catalog.GetString ("Play _Album..."));
		...
		show_window_menu_item = new MenuItem (AppContext.Catalog.GetString ("Show _Window"));
